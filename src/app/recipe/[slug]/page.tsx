  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Learn how to make ${recipe.title}. Ready in ${recipe.readyInMinutes} minutes. Serves ${recipe.servings} people.`} />
        <meta name="keywords" content={`recipe, ${recipe.title}, cooking, ingredients, food`} />
        <meta property="og:title" content={`${recipe.title} - Recipe Details`} />
        <meta property="og:description" content={`Learn how to make ${recipe.title}. Ready in ${recipe.readyInMinutes} minutes.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "recipeIngredient": recipe.extendedIngredients.map(ing => `${ing.amount} ${ing.unit} ${ing.name}`),
